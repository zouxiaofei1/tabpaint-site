...
TabPaint is an image workshop that sits between traditional "Paint" and "Image Viewer" software. You can start by trying these features:

## 1. Multi-tab Management
TabPaint introduces a multi-tab mechanism.
...
*   **Auto Listening**: After enabling listening mode with `Ctrl + Alt + P`, TabPaint will automatically open new screenshots as new tabs.
*   **AI Background Removal**: Combined with various removal tools, images can have backgrounds automatically removed without needing to save, open screenshot folders, or manually copy-paste.
